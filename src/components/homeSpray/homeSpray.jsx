    ...
    <div>
      ...
      <div className={stylesSpray.container}>
        <div className={stylesSpray.card}>
          <div className={stylesSpray.contImg}>
            ...
            <div className={stylesSpray.contImgChica}>
              <img src="https://acdn.mitiendanube.com/stores/492/056/products/img_35481-396b97c13d9d430d5416549593579806-1024-1024.jpg" alt="" className={stylesSpray.imgChica}/>
              <img src="https://acdn.mitiendanube.com/stores/492/056/products/img_35481-396b97c13d9d430d5416549593579806-1024-1024.jpg" alt="" className={stylesSpray.imgChica}/>
            </div>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <button className={stylesSpray.btnAgregar}>Agregar</button>
          </div>
        </div>
        <div className={stylesSpray.card}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center',  marginBottom: '20px' }}>
